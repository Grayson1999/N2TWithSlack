...
class Notion2Tistory:
    def __init__(self, cfg, sleep_time=10, selenium_debug=False):
        ...
        if len(self.pages) == 0:
            slack_message_with_time('[완료] 발행할 할 페이지가 없습니다.')
            sys.exit(1)
        ...
        try:
            ...
            slack_message_with_time('[오류] 카카오톡 로그인 실패')
            sys.exit(1)
    ...
    def parse_and_post(self, page, filepath):
        ...
        try:
            ...
            slack_message_with_time('[Error] 테이블의 컬럼명을 다시 확인해주세요.')
...
if __name__ == '__main__':
    ...
    try:
        ...
        slack_message_with_time(content)
    except Exception as e:
    ...
    # slack_message_with_time('[완료] 프로그램 종료.')
